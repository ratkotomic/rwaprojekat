    ...
    <main class="mdl-layout__content">
            ...
            <div class="wrapper py-1 w-80 px-2 flex flex-column flex-center gap-2">
                ...
                <div class="action flex flex-row flex-center flex-wrap gap-3">
                    ...
                    <button id="next-question-button"
                            class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored  " disabled>
        ...
        <div class="container h-100 flex-column flex-center quiz-end">
            <div class="wrapper py-1 w-80 px-2 flex flex-column flex-center gap-2">
                ...
                <div class="action flex flex-row flex-center flex-wrap gap-3">
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored " id="preuzmiListu">
                        Preuzmi listu
                    </button>
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored  " id="nazadButton">
                        Nazad
                    </button>
                </div>
            </div>
...
<script>
    ...
    document.getElementById("nazadButton").addEventListener("click", function () {
        window.location.href = "/rwaprojekat/admin/home";
    });

    const params = new URLSearchParams({pin: game.pin});

    document.getElementById("preuzmiListu").addEventListener("click", function () {
        fetch("/rwaprojekat/getPlayers?" + params)
            .then(response => {
                if (!response.ok) {
